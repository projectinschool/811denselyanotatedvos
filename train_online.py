...
save_result_dir="/content/OSVOS-PyTorch/models/new_result"
...
net.load_state_dict(torch.load(os.path.join(save_dir, 'blackswan_epoch-9999.pth'),
...
with torch.no_grad():  # PyTorch 0.4.0 style
    ...
    for ii, sample_batched in enumerate(testloader):
        ...
        for jj in range(int(inputs.size()[0])):
            ...
            sm.imsave(os.path.join(save_result_dir, os.path.basename(fname[jj]) + '.png'), pred)
